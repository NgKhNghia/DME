...
g++ application/tokenRing.cpp -o application/tokenRing -lpthread -Iframework -Ialgorithm -fPIE
# g++ application/naimiTrehel.cpp -o application/naimiTrehel -lpthread -Iframework -Ialgorithm
